...
sealed class DashSdkError(
    ...
    sealed class PlatformWallet(
        ...
        /**
         * `ErrorShieldedClaimUnconfirmed` (native code 49 — renumbered from
         * 48 when merged #4356 took 47/48 as ABI,
    ...
    companion object {
        ...
        private fun fromPlatformWalletNative(
            ...
            // identity slot. 49 — renumbered from the branch's original 48
            // when merged #4356 took 47/48 (AssetLockInputConflict /
            // AssetLockInputContested) as ABI.
            49 -> PlatformWallet.ShieldedClaimUnconfirmed(message, cause)
            else ->
