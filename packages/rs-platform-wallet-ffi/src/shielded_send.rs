...
/// withdraw / shield / shield-to-recipient). Paired with `ErrorShieldedSpendUnconfirmed` in
/// [`catch_spend_panic`].
...
/// [`PlatformWalletFFIResultCode::ErrorShieldedClaimUnconfirmed`] (49),
...
///   retryable-as-resume `ErrorShieldedClaimUnconfirmed` (49) with
...
mod tests {
    ...
    ///
    /// The code must be the dedicated `ErrorShieldedClaimUnconfirmed` (49) — NOT the generic
