...
public enum PlatformWalletResultCode: Int32, Sendable {
    ...
    ///
    /// Raw value 49 — renumbered from the branch's original 48 when merged
    /// #4356 took 47 (`errorAssetLockInputConflict`) and 48
    /// (`errorAssetLockInputContested`) as ABI. MUST match
    /// `ErrorShieldedClaimUnconfirmed` in
    /// packages/rs-platform-wallet-ffi/src/error.rs.
    case errorShieldedClaimUnconfirmed = 49
